							...
							<ul class="mt-3">
								<li class="flex items-center">
									...
									<a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-gray-700 text-sm ml-3">
										...
										<strong>Office No.306, B-Wing, Season Square Aundh ITI Road Aundh, Pune 411007</strong>
									</a>
								</li>
							</ul>
						</div>
						...
						<div class="mt-2">
							...
							<ul class="mt-3">
								<li class="flex items-center">
									...
									<a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-gray-700 text-sm ml-3">
										<!-- <small class="block">Mail</small> -->
										<strong>917576919191 - 919890008077</strong>
									</a>
								</li>
							</ul>
						</div>
						<h2>
							To open Demat account ,contact us
						</h2>
